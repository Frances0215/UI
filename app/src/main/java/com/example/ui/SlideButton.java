...
public class SlideButton extends View {
    ...
    //圆形checked填充颜色
    private String CircleCheckedColor = "#99c5d5";
    //圆形非checked填充颜色
    private String CircleNoCheckedColor = "#bebfc1";

    //控件内边距
    private static float PADDING = 20;
    //移动的判定距离
    private static float MOVE_DISTANCE = 50;
    ...
    public void setOnCheckedListener(OnClickListener listener) {
        this.mListener = (SlideButtonOnCheckedListener) listener;
    }
